      ...
      <div class="container">
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#plyty">Produkty</a>
            </li>
            <li class="nav-item">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Doro Sklep</div>
          <div class="intro-heading text-uppercase"></div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#plyty">Sklep</a>
        </div>
      </div>
    </header>
                        ...
                        while ($product = mysqli_fetch_assoc($result)): // mysqli_fetch_assoc - Pobierz wiersz wyniku jako tablicę w pętli dla każdego id
                            ...
                            <div class="col-md-4 text-center">
                                <form method="post" action="index.php?action=add&id=<?php echo $product['id']; ?>#plyty">
                                    <div class="products">
                                        <?php //substr function to delete "../" prefix?>
                                        <a href="<?php echo substr($product['image'], 3); ?>" target="_BLANK"><img src="<?php echo substr($product['image'], 3); ?>" class="img-thumbnail" style="max-width: 100%; max-height: 100%;"/></a>
                                        <div class="opis">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted"><a href="#" target="_BLANK">Blargh!</a></h3>
          </div>
        </div>
